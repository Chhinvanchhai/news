            ...
            <div class="col-md-8 col-xs-12">
               ...
               <div class="row">
                <?php 
                    ...
                    $query=mysqli_query($con,"select tblposts.id as pid,tblposts.PostTitle as posttitle,tblposts.featureText as featureText,tblposts.PostImage,tblcategory.CategoryName as category,tblsubcategory.Subcategory as subcategory,tblposts.PostDetails as postdetails,tblposts.PostingDate as postingdate,tblposts.PostUrl as url from tblposts left join tblcategory on tblcategory.id=tblposts.CategoryId left join  tblsubcategory on  tblsubcategory.SubCategoryId=tblposts.SubCategoryId where tblposts.CategoryId='".$_REQUEST['catid']."' and tblposts.Is_Active=1 order by tblposts.id desc LIMIT $offset, $no_of_records_per_page");
                ...
                <?php 
                  if(mysqli_num_rows($query)==0){
                     echo "<h2 style='text-align:center;margin:60px 0px;'>Do not have data in these category yet!";
                  }
                ?>
               </div>
               <!-- Pagination -->
